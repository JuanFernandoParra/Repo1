...
setwd("/Users/juanfernandoparra/Documents/DECENCIA/UAN/2019/Hackeando/Taller_OAW_2019")
...
summary(bd_error_transpose$BOYACA)
...
boxplot(bd_error_transpose, notch = T)
